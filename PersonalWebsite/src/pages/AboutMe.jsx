...
const AboutMe = () => {
  ...
  return (
    ...
    <div style={{ fontFamily: "Nimbus Mono, monospace" }} className='min-h-screen w-full px-8 py-12 mt-5 flex flex-row gap-10 items-start justify-center text-[#f7e2c7] z-10 min-h-screen'>
