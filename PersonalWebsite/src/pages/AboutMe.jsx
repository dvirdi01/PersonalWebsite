...
const AboutMe = () => {
  ...
  return (
    <Fade triggerOnce={true} ref={ref}>
    <div style={{ fontFamily: "Nimbus Mono, monospace" }} className='bg-[#0d1117] min-h-screen w-full px-8 py-12 mt-5 flex flex-row gap-10 items-start justify-center text-white z-10 min-h-screen'>
